[![Build Status](https://travis-ci.org/ptavares/ippon-hackathon.svg?branch=master)](https://travis-ci.org/ptavares/ippon-hackathon)
...
To optimize the CookSmart application for production, run:
